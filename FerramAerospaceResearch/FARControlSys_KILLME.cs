...
/*        public void FlapChange()
        ...
        private void GetFlightCondition()
        {
            ...
            double temp = FlightGlobals.getExternalTemperature((float)vessel.altitude, vessel.mainBody);

            temp *= FARAeroUtil.ReferenceTemperatureRatio(MachNumber, 0.843, vessel.mainBody.atmosphereAdiabaticIndex);
...
//            SaveFlightDataPos.y = FlightDataPos.y;
            ...
            FlightDataPos = GUIUtils.ClampToScreen(FlightDataPos);
        }
...
//            SaveFlightDataHelpPos.y = FlightDataHelpPos.y;
            ...
            FlightDataHelpPos = GUIUtils.ClampToScreen(FlightDataHelpPos);
        }
...
//            SaveHelpPos.y = HelpWindowPos.y;
            ...
            HelpWindowPos = GUIUtils.ClampToScreen(HelpWindowPos);
        }
        ...
        { 
            ...
            AutoPilotWindowPos = GUIUtils.ClampToScreen(AutoPilotWindowPos);
        }
...
//            SaveWindowPos.y = windowPos.y;
            ...
            windowPos = GUIUtils.ClampToScreen(windowPos);
        }
...
//            SaveAirSpeedPos.y = AirSpeedPos.y;
            ...
            GUI.DragWindow();
            AirSpeedPos = GUIUtils.ClampToScreen(AirSpeedPos);
        }
...
//            SaveAirSpeedHelpPos.y = AirSpeedHelpPos.y;
            ...
            AirSpeedHelpPos = GUIUtils.ClampToScreen(AirSpeedHelpPos);
        }
        ...
        private void AeroForceTintingGUI(int windowID)
        {
            ...
            fullySaturatedCl = GUIUtils.TextEntryForDouble("Cl For Full Tint:", 80, fullySaturatedCl);

            
            tintForCd = GUILayout.Toggle(tintForCd, "Tint Cd");
            fullySaturatedCd = GUIUtils.TextEntryForDouble("Cd For Full Tint:", 80, fullySaturatedCd);

            tintForStall = GUILayout.Toggle(tintForStall, "Tint Stall");

            GUI.DragWindow();

            AeroForceTintingPos = GUIUtils.ClampToScreen(AeroForceTintingPos);
        }
