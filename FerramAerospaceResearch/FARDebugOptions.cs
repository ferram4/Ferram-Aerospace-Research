...
namespace ferram4
{
    ...
    public class FARDebugOptions : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            ...
            if (debugMenu)
            {
                debugWinPos = GUILayout.Window("FARDebug".GetHashCode(), debugWinPos, debugWindow, "FAR Debug Options, v0.14.5", GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
